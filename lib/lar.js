 ...
 */
 ...
 !(function (exports) {
  ...
  ops.extrude = function (cells) { 
    ...
    cells.forEach(function (cell) {
      prism = cell.concat(cell.map(function (coord) {
        return coord + nextIndex;
      }));
  ...
  lar.Topology.prototype.extrude = function () {
    return operator;
  };
  ...
  lar.Model.prototype.submodel = function (d, selector) {
  ...
  lar.Model.prototype.boundary = function (i, chain) {
    ...
    var chain = chain || flat(ones(1,c_i0.length));
  ...
  lar.Model.extrude = function (h) {
    ...
    vertices.forEach(function (v) {
      newVertex = v.slice(0).push(0);
      newTranslatedVertex = v.slice(0).push(h);
      newVertices.push(newVertex);
      newTranslatedVertices.push(newTranslatedVertex);
    });

    newVertices = newVertices.concat(newTranslatedVertex);
    newCells = this.topology.extrude();
