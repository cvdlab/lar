 ...
 */
 ...
 !(function (exports) {
   ...
   * @return {Array} d-cells as array of arrays 
   * @api public
   */

  lar.Model.prototype.chain = function (d, selector) {
    var topology = this.topology;
    var c_d0 = topology.get(d,0);
    var cells;
  ...
  lar.Model.prototype.cells = function (d) {
  ...
  lar.Model.prototype.map = function (i, chain) {
